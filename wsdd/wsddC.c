...
SOAP_SOURCE_STAMP("@(#) wsddC.c ver 2.8.7 2013-03-27 08:28:05 GMT")
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out_wsdd__ProbeType(struct soap *soap, const char *tag, int id, const struct wsdd__ProbeType *a, const char *type)
{
    ...
    if (soap_out_wsdd__QNameListType(soap, "wsdd:Types", -1, (char*const*)&soap_tmp_Types, ""))
        return soap->error;
    // original: if (a->Scopes && soap_out_PointerTowsdd__ScopesType(soap, "wsdd:Scopes", -1, &a->Scopes, ""))
    if (a->Scopes && soap_out_PointerTowsdd__ScopesType(soap, "wsdd:Scopes", -1, &a->Scopes, ""))
        return soap->error;
    return soap_element_end_out(soap, tag);
}
